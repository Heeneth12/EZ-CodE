            ...
            <div className="md:flex md:items-center md:justify-between">
              <div className="flex justify-center md:justify-start space-x-6">
                ...
                <a href="#" className="text-gray-400 hover:text-gray-300">
                  ...
                  <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M23.643 4.937c-.835.37-1.732.62-2.675.735a4.688 4.688 0 002.063-2.573c-.91.54-1.917.935-2.985 1.144a4.724 4.724 0 00-8.036 4.3A13.394 13.394 0 011.67 3.149a4.686 4.686 0 001.465 6.283A4.693 4.693 0 01.96 9v1a4.72 4.72 0 003.776-1.043A4.706 4.706 0 007 .5a13.38 13.38 0 009 .004c-.08-.35-.12-.71-.12-1a13.33 13.33 0 01-3 .11c1 .64 2 .99 3 .99z"></path>
                  </svg>
                </a>
              </div>
            </div>
